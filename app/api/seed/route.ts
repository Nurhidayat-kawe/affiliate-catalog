  ...
  try {
    ...
    for (const p of products) {
      ...
      await db.execute({
        ...
        args: [p.name, p.image_url, JSON.stringify(allImages.slice(0, 5)), p.video_url, p.price, p.affiliate_link, p.rating, "Shopee"],
      });
    }
